var nph = require("./index.js"),
  ...
  //data = [1,32,43,67,4,5,0,0,0,0,0,0,34,56,90,30,]
...
app.get('/image', function (req, res) {
  ...
  new nph({data: data, mirror: true, width: 1800, height: 150, color: {r: 0, g: 0, b:0, a: 100}, pattern: true}).generatePNG(function (alldata) {
    //var tm4 = new Date();
    //console.log(tm4 - tm3);
